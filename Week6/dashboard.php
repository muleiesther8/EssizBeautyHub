<?php
// ============================================================
// ESSIZ BEAUTY HUB — Week 5 Customer Dashboard
...
<div class="dashboard-header">
  <div class="container">
    <div class="dashboard-welcome">
      <div class="welcome-avatar"><?php echo strtoupper(substr($full_name,0,1)); ?></div>
      <div>
...
<div class="container dashboard-body">
  ...
  <div class="dash-section">
    ...
    <div class="quick-links">
      ...
      <a href="#"                  class="quick-link"><span>👤</span><p>Edit Profile</p></a>
    </div>
  </div>
