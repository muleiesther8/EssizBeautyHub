<?php
// ============================================================
// ESSIZ BEAUTY HUB — Week 5 Admin Orders
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['order_id'])) {
    ...
    if (in_array($new_status, $allowed)) {
        ...
        mysqli_stmt_execute($stmt) ? $message = 'Order #' . $order_id . ' status updated to ' . $new_status . '!' : $message = 'Update failed.';
    }
}
...
<div class="admin-layout">
  ...
  <main class="admin-main">
    <div class="admin-header">
      <div class="admin-header">
  <div><h1>Manage Orders</h1><p>View and update all customer orders</p></div>
  <div style="display:flex;gap:12px;">
    <a href="orders.php" class="btn-primary">← All Orders</a>
    <a href="dashboard.php" class="btn-outline">Dashboard</a>
  </div>
</div>

    <?php if (isset($_GET['success'])): ?>
    <div class="form-message form-message--success" style="display:flex;align-items:center;justify-content:space-between;">
        <span>✓ Order status updated successfully!</span>
        <a href="orders.php" class="btn-sm btn-sm--edit">View All Orders →</a>
    </div>
<?php endif; ?>
        ...
        <table class="admin-table">
          <thead>
            <tr>
              ...
              <th>Total</th><th>Payment</th><th>Delivery Location</th>
          ...
          <tbody>
            <?php if (mysqli_num_rows($orders_result) > 0):
              while ($order = mysqli_fetch_assoc($orders_result)):
                $sc = ['Pending'=>'status--pending','Packed'=>'status--packed','On the way'=>'status--shipping','Delivered'=>'status--delivered'][$order['order_status']] ?? '';
            ?>
            <tr>
              ...
              <td><span class="status-badge <?php echo $sc; ?>"><?php echo $order['order_status']; ?></span></td>
            ...
            <?php endwhile; else: ?>
            <tr><td colspan="10" style="text-align:center;color:#888;padding:40px;">No orders yet</td></tr>
            <?php endif; ?>
          </tbody>
        </table>
      </div>
