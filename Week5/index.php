<?php
// ============================================================
// ESSIZ BEAUTY HUB — Week 5 Homepage
...
<head>
  ...
  <title><?php echo $site_name; ?> — Intelligent Beauty</title>
  ...
  <div class="nav-container">
    ...
    <ul class="nav-links" id="navLinks">
      ...
      <?php if ($is_logged): ?>
        ...
        <?php if (isAdmin()): ?><li><a href="admin/dashboard.php" class="btn-nav">Admin</a></li><?php endif; ?>
...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-actions fade-in">
      ...
      <?php else: ?>
        <a href="routine_builder.php" class="btn-outline">Build My Routine</a>
      <?php endif; ?>
    </div>
    <div class="hero-stats fade-in">
      <div class="stat"><strong><?php echo $total_products; ?>+</strong><span>Products</span></div>
      <div class="stat-divider"></div>
      <div class="stat"><strong><?php echo $total_users; ?>+</strong><span>Happy Customers</span></div>
      <div class="stat-divider"></div>
      ...
      <div class="product-card">
        ...
        <div class="product-info">
          ...
          <div class="product-rating">
            ...
            <span class="rating-num">(<?php echo $p['rating']; ?>) · <?php echo $p['review_count']; ?> reviews</span>
          </div>
...
<section class="recommendation-banner">
  <div class="container">
    <div class="rec-content">
      ...
      <div class="rec-text">
        <h3>Build Your Perfect Beauty Routine</h3>
        <p>Morning or night — we'll help you build a personalized routine based on your skin type and budget.</p>
      </div>
      <a href="<?php echo $is_logged ? 'routine_builder.php' : 'register.php'; ?>" class="btn-primary">
        <?php echo $is_logged ? 'Build My Routine' : 'Get Started Free'; ?>
      </a>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="bundles-grid">
      <div class="bundle-card" onclick="openBundle('campus')">
        ...
        <button class="btn-primary">View Bundle</button>
      </div>
