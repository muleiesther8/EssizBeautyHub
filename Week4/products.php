<?php
// ============================================================
// ESSIZ BEAUTY HUB — Week 4 Products Page
  ...
  <aside class="filters-sidebar" id="filtersSidebar">
    ...
    <div class="filter-group">
      ...
      <div class="filter-options">
        ...
        <label class="filter-option"><input type="checkbox" name="skin" value="<?php echo $s; ?>" checked> <?php echo $s; ?> Skin</label>
        <?php endforeach; ?>
      </div>
    </div>
    <div class="filter-group">
  ...
  <main class="products-main">
    ...
    <div class="products-grid" id="productsGrid">
      ...
      <div class="product-card"
           ...
           data-skin="<?php echo $product['skin_type']; ?>"
        ...
        <div class="product-info">
          ...
          <span class="product-skin">For: <?php echo $product['skin_type']; ?> skin</span>
