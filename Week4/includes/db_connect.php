<?php
// ============================================================
// ESSIZ BEAUTY HUB — Week 4 Database Connection
...
if (!$conn) {
    ...
    <div style='font-family:sans-serif;padding:30px;background:#FFF0F3;border:1px solid #E8869A;border-radius:12px;max-width:500px;margin:40px auto;'>
      ...
      <p style='color:#555;margin-top:10px;'>Could not connect to <strong>essizdb_w4</strong>.</p>
      <p style='color:#555;margin-top:6px;'>Make sure XAMPP is running and essizdb_w4.sql is imported.</p>
