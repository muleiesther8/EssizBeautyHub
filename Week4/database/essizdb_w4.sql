-- ============================================================
-- ESSIZ BEAUTY HUB — Week 4 Database
-- BIT3208 Advanced Web Design and Development
-- Database: essizdb_w4
-- Week 4: Added sessions, cart, orders, order_items
-- ============================================================

CREATE DATABASE IF NOT EXISTS essizdb_w4
...
('Admin User',    'admin@essizbeautyhub.com',    '0734756300', 'placeholder', 'admin',    'Normal'),
('Jane Wanjiru',  'janewanjiru254@gmail.com',    '0714319876', 'placeholder', 'customer', 'Oily'),
('Aisha Kamau',   'aishakamau.beauty@gmail.com', '0722124351', 'placeholder', 'customer', 'Dry'),
('Grace Muthoni', 'gracemuthoni95@gmail.com',    '0735648709', 'placeholder', 'customer', 'Combination');
...
('Acne Control Cleanser', 'Skincare',    'Gentle cleanser for acne-prone skin',   550.00,   8, 'Oily',      4.1),
...
('Rose Water Mist',       'Skincare',    'Refreshing hydrating face mist',        480.00,   5, 'Sensitive', 4.3),
