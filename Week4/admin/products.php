<?php
// ============================================================
// ESSIZ BEAUTY HUB — Week 4 Admin Products
// BIT3208 Advanced Web Design and Development
// File: admin/products.php — Full CRUD
// ============================================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($product_id > 0) {
        ...
        mysqli_stmt_bind_param($stmt, "sssdisdi",
            $name, $category, $description, $price, $stock, $skin_type, $rating, $product_id
        );
        mysqli_stmt_execute($stmt) ? $message = 'Product updated successfully!' : $error = 'Update failed.';
    } else {
        // INSERT
        $stmt = mysqli_prepare($conn,
        ...
        mysqli_stmt_bind_param($stmt, "sssdisi",
            $name, $category, $description, $price, $stock, $skin_type, $rating
        );
        mysqli_stmt_execute($stmt) ? $message = 'Product added successfully!' : $error = 'Add failed.';
    }
}
...
<head>
  ...
  <title>Essiz Beauty Hub — Manage Products</title>
  ...
  <main class="admin-main">
    ...
    <div class="admin-form-card" id="productForm">
      ...
      <form method="POST" action="products.php">
        ...
        <div class="form-group">
          ...
          <textarea name="description" placeholder="Product description..." rows="3" style="width:100%;padding:12px;border:1.5px solid var(--border);border-radius:var(--radius-md);font-family:var(--font-body);font-size:14px;outline:none;"><?php echo htmlspecialchars($edit_product['description'] ?? ''); ?></textarea>
        </div>
    ...
    <div class="admin-table-card">
      <div class="admin-table-header">
        <h3>All Products (<?php echo mysqli_num_rows($products); ?>)</h3>
      </div>
      <div class="table-wrapper">
        <table class="admin-table">
          <thead>
            <tr>
              <th>ID</th><th>Name</th><th>Category</th><th>Price</th><th>Stock</th><th>Skin Type</th><th>Rating</th><th>Actions</th>
            </tr>
          </thead>
          <tbody>
