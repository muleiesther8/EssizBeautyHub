<?php
// ============================================================
// ESSIZ BEAUTY HUB — Week 4 Admin Users
...
// Delete user (prevent deleting self or other admins)
...
<div class="admin-layout">
  ...
  <main class="admin-main">
    <div class="admin-header">
      <div>
        <h1>Manage Users</h1>
        <p>View all registered customers and admins</p>
      </div>
    </div>
        ...
        <table class="admin-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <span style="
                  display:inline-block;padding:3px 10px;border-radius:100px;font-size:11px;font-weight:500;
                  background:<?php echo $user['role'] === 'admin' ? 'var(--pink)' : 'var(--lav-soft)'; ?>;
                  color:<?php echo $user['role'] === 'admin' ? 'white' : 'var(--lavender)'; ?>;">
